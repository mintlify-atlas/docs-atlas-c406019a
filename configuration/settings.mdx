...
<CardGroup cols={2}>
  <Card title="Language and Region" icon="globe" href="/configuration/settings#language-region">
  ...
  <Card title="Spare Parts Management" icon="wrench" href="/configuration/settings#spare-parts">
  ...
  <Card title="AI Module" icon="brain" href="/configuration/settings#ai-module">
